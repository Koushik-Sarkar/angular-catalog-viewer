...
describe("CatalogItemsComponent", () => {
  ...
  it(
    "click/hover on catalog thumb should update the viewer image",
    fakeAsync(() => {
  ...
  it(
    'the first catalog thumb should have a background image "/assets/images/thumb/mobile-front-thumb.jpeg"',
    async(() => {
  ...
  it(
    'selected thumb should be highlighted with blue border by applying css class "thumb-select',
    fakeAsync(() => {
      component.items = [...catalog];
      component.currentIndex = 0;
      fixture.detectChanges();
